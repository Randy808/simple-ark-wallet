...
const Receive: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow p-6">
      <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Receive Bitcoin</h2>
      
      <div className="mb-8">
        <div className="aspect-square w-full max-w-xs mx-auto bg-white p-4 rounded-lg shadow-inner mb-6">
          <img
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            The sender will pay the network fee. You'll receive the exact amount sent.
          </p>
        </div>
      </div>
    </div>
